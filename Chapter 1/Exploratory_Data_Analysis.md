...
Scatterplot, Hexagonal binning, boxplot are used to compare 2 variables and can also be extended to more variables using the notion of conditioning/facets and facers are easier in seaborn than Matplotlib.
